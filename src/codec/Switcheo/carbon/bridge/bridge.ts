  ...
  fromJSON(object: any): Withdrawal {
    ...
    message.amount =
      object.amount !== undefined && object.amount !== null
        ...
        : "";
    message.usdValue =
      object.usdValue !== undefined && object.usdValue !== null
        ? String(object.usdValue)
        : "";
    message.timestamp =
    ...
    message.nonce =
      object.nonce !== undefined && object.nonce !== null
        ...
        : Long.UZERO;
    message.srcChannel =
      object.srcChannel !== undefined && object.srcChannel !== null
        ? String(object.srcChannel)
        : "";
    return message;
  },
...
export const Withdrawals = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Withdrawals {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseWithdrawals } as Withdrawals;
    message.withdrawals = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
