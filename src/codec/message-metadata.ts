...
*/
export type EIP712FieldDefinition = { name: string; type: string; packageName?: string };
export const EIP712Types: Record<string, Record<string, EIP712FieldDefinition[]>> = {
  "/google.protobuf": {
    "FileDescriptorSet": [
      {
        "name": "file",
