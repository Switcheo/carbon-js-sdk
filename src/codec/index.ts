...
import { MsgAddRateStrategy, MsgAddRateStrategyResponse, MsgUpdateRateStrategy, MsgUpdateRateStrategyResponse, MsgRemoveRateStrategy, MsgRemoveRateStrategyResponse, MsgAddAsset, MsgAddAssetResponse, MsgUpdateAsset, MsgUpdateAssetResponse, MsgSupplyAsset, MsgSupplyAssetResponse, MsgWithdrawAsset, MsgWithdrawAssetResponse, MsgLockCollateral, MsgLockCollateralResponse, MsgUnlockCollateral, MsgUnlockCollateralResponse, MsgBorrowAsset, MsgBorrowAssetResponse, MsgRepayAsset, MsgRepayAssetResponse, MsgSupplyAndLockAsset, MsgSupplyAndLockAssetResponse, MsgUnlockAndWithdrawAsset, MsgUnlockAndWithdrawAssetResponse, MsgLiquidateCollateral, MsgLiquidateCollateralResponse, MsgSetLiquidationFee, MsgSetLiquidationFeeResponse, MsgSetInterestFee, MsgSetInterestFeeResponse, MsgSetStableCoinInterestRate, MsgSetStableCoinInterestRateResponse } from "./cdp/tx";
...
registry.register("/Switcheo.carbon.cdp.MsgSupplyAndLockAsset", MsgSupplyAndLockAsset);
registry.register("/Switcheo.carbon.cdp.MsgSupplyAndLockAssetResponse", MsgSupplyAndLockAssetResponse);
registry.register("/Switcheo.carbon.cdp.MsgUnlockAndWithdrawAsset", MsgUnlockAndWithdrawAsset);
registry.register("/Switcheo.carbon.cdp.MsgUnlockAndWithdrawAssetResponse", MsgUnlockAndWithdrawAssetResponse);
...
export const TxTypes = {
  ...
  "MsgSupplyAndLockAsset": "/Switcheo.carbon.cdp.MsgSupplyAndLockAsset",
  "MsgSupplyAndLockAssetResponse": "/Switcheo.carbon.cdp.MsgSupplyAndLockAssetResponse",
  "MsgUnlockAndWithdrawAsset": "/Switcheo.carbon.cdp.MsgUnlockAndWithdrawAsset",
  "MsgUnlockAndWithdrawAssetResponse": "/Switcheo.carbon.cdp.MsgUnlockAndWithdrawAssetResponse",
...
export { AssetParams, AssetUtilization, AssetData } from "./cdp/asset_params";
