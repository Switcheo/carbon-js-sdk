...
export class CarbonWallet {
  ...
  public static withStation(station: Station, chainId: string, publicKey: string, opts: Omit<CarbonWalletInitOpts, "signer"> = {}) {
    const signer = StationAccount.createStationSigner(station, chainId, publicKey);
