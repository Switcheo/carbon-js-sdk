...
class TokenClient {
  ...
  public async reloadUSDValues(denoms: string[] = Object.keys(this.tokens)): Promise<TypeUtils.SimpleMap<BigNumber>> {
    ...
    for (const denom of denoms) {
      // if token price for denom is set alr, continue
  ...
  async reloadTokenPrices(): Promise<TypeUtils.SimpleMap<BigNumber>> {
