...
export const toHuman = (value?: null | BigNumber | string | number, decimals?: null | BigNumber | string | number): BigNumber | undefined => {
...
export const toUnitless = (value?: null | BigNumber | string | number, decimals?: null | BigNumber | string | number): BigNumber | undefined => {
  if (value === undefined || value === null) return undefined;
