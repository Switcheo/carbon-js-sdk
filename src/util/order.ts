...
export function isMarket(type: OrderModule.OrderType | string): boolean {
  ...
  return (
    newType === (OrderModule.OrderType.Market as string) ||
    newType === (OrderModule.OrderType.StopMarket as string) ||
    newType === (OrderModule.OrderType.TakeProfitMarket as string)
  );
}
