...
export interface MultiSwapResultantDB {
  id: Long;
  blockHeight: Long;
  address: string;
  inputDenom: string;
...
export interface MultiSwapStepDB {
  id: Long;
  blockHeight: Long;
  address: string;
  inputDenom: string;
...
const baseMultiSwapResultantDB: object = {
  id: Long.UZERO,
  blockHeight: Long.UZERO,
  address: "",
  inputDenom: "",
...
export const MultiSwapResultantDB = {
  encode(
    message: MultiSwapResultantDB,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (!message.id.isZero()) {
      writer.uint32(8).uint64(message.id);
    ...
    if (message.swapType !== "") {
      writer.uint32(74).string(message.swapType);
    }
  ...
  decode(
    ...
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMultiSwapResultantDB } as MultiSwapResultantDB;
    message.swapRoute = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromJSON(object: any): MultiSwapResultantDB {
    const message = { ...baseMultiSwapResultantDB } as MultiSwapResultantDB;
    message.id =
      object.id !== undefined && object.id !== null
        ? Long.fromString(object.id)
  ...
  toJSON(message: MultiSwapResultantDB): unknown {
    const obj: any = {};
    message.id !== undefined &&
      (obj.id = (message.id || Long.UZERO).toString());
    message.blockHeight !== undefined &&
  ...
  fromPartial(object: DeepPartial<MultiSwapResultantDB>): MultiSwapResultantDB {
    const message = { ...baseMultiSwapResultantDB } as MultiSwapResultantDB;
    message.id =
      object.id !== undefined && object.id !== null
        ? Long.fromValue(object.id)
...
const baseMultiSwapStepDB: object = {
  id: Long.UZERO,
  blockHeight: Long.UZERO,
  address: "",
  inputDenom: "",
...
export const MultiSwapStepDB = {
  encode(
    message: MultiSwapStepDB,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    if (!message.id.isZero()) {
      writer.uint32(8).uint64(message.id);
    ...
    if (message.swapType !== "") {
      writer.uint32(66).string(message.swapType);
    }
    if (!message.poolId.isZero()) {
      writer.uint32(72).uint64(message.poolId);
    }
    if (!message.stepNumber.isZero()) {
      writer.uint32(80).uint64(message.stepNumber);
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MultiSwapStepDB {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMultiSwapStepDB } as MultiSwapStepDB;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MultiSwapStepDB {
    const message = { ...baseMultiSwapStepDB } as MultiSwapStepDB;
    message.id =
      object.id !== undefined && object.id !== null
        ? Long.fromString(object.id)
  ...
  toJSON(message: MultiSwapStepDB): unknown {
    const obj: any = {};
    message.id !== undefined &&
      (obj.id = (message.id || Long.UZERO).toString());
    message.blockHeight !== undefined &&
  ...
  fromPartial(object: DeepPartial<MultiSwapStepDB>): MultiSwapStepDB {
    const message = { ...baseMultiSwapStepDB } as MultiSwapStepDB;
    message.id =
      object.id !== undefined && object.id !== null
        ? Long.fromValue(object.id)
