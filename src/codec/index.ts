...
import * as Cosmos from './cosmos-models';
...
registry.register("/cosmos.upgrade.v1beta1.MsgSoftwareUpgrade", Cosmos.Upgrade.MsgSoftwareUpgrade);
registry.register("/cosmos.upgrade.v1beta1.MsgSoftwareUpgradeResponse", Cosmos.Upgrade.MsgSoftwareUpgradeResponse);
registry.register("/cosmos.upgrade.v1beta1.MsgCancelUpgrade", Cosmos.Upgrade.MsgCancelUpgrade);
registry.register("/cosmos.upgrade.v1beta1.MsgCancelUpgradeResponse", Cosmos.Upgrade.MsgCancelUpgradeResponse);
registry.register("/cosmos.upgrade.v1beta1.SoftwareUpgradeProposal", Cosmos.Upgrade.SoftwareUpgradeProposal);
registry.register("/cosmos.upgrade.v1beta1.CancelSoftwareUpgradeProposal", Cosmos.Upgrade.CancelSoftwareUpgradeProposal);

registry.register("/cosmos.feegrant.v1beta1.MsgGrantAllowance", Cosmos.Feegrant.MsgGrantAllowance);
registry.register("/cosmos.feegrant.v1beta1.MsgGrantAllowanceResponse", Cosmos.Feegrant.MsgGrantAllowanceResponse);
registry.register("/cosmos.feegrant.v1beta1.MsgRevokeAllowance", Cosmos.Feegrant.MsgRevokeAllowance);
registry.register("/cosmos.feegrant.v1beta1.MsgRevokeAllowanceResponse", Cosmos.Feegrant.MsgRevokeAllowanceResponse);

registry.register("/cosmos.evidence.v1beta1.MsgSubmitEvidence", Cosmos.Evidence.MsgSubmitEvidence);
registry.register("/cosmos.evidence.v1beta1.MsgSubmitEvidenceResponse", Cosmos.Evidence.MsgSubmitEvidenceResponse);

registry.register("/cosmos.nft.v1beta1.MsgSend", Cosmos.Nft.MsgSend);
registry.register("/cosmos.nft.v1beta1.MsgSendResponse", Cosmos.Nft.MsgSendResponse);

registry.register("/cosmos.group.v1.MsgCreateGroup", Cosmos.Group.MsgCreateGroup);
registry.register("/cosmos.group.v1.MsgCreateGroupResponse", Cosmos.Group.MsgCreateGroupResponse);
registry.register("/cosmos.group.v1.MsgUpdateGroupMembers", Cosmos.Group.MsgUpdateGroupMembers);
registry.register("/cosmos.group.v1.MsgUpdateGroupMembersResponse", Cosmos.Group.MsgUpdateGroupMembersResponse);
registry.register("/cosmos.group.v1.MsgUpdateGroupAdmin", Cosmos.Group.MsgUpdateGroupAdmin);
registry.register("/cosmos.group.v1.MsgUpdateGroupAdminResponse", Cosmos.Group.MsgUpdateGroupAdminResponse);
registry.register("/cosmos.group.v1.MsgUpdateGroupMetadata", Cosmos.Group.MsgUpdateGroupMetadata);
registry.register("/cosmos.group.v1.MsgUpdateGroupMetadataResponse", Cosmos.Group.MsgUpdateGroupMetadataResponse);
registry.register("/cosmos.group.v1.MsgCreateGroupPolicy", Cosmos.Group.MsgCreateGroupPolicy);
registry.register("/cosmos.group.v1.MsgCreateGroupPolicyResponse", Cosmos.Group.MsgCreateGroupPolicyResponse);
registry.register("/cosmos.group.v1.MsgUpdateGroupPolicyAdmin", Cosmos.Group.MsgUpdateGroupPolicyAdmin);
registry.register("/cosmos.group.v1.MsgCreateGroupWithPolicy", Cosmos.Group.MsgCreateGroupWithPolicy);
registry.register("/cosmos.group.v1.MsgCreateGroupWithPolicyResponse", Cosmos.Group.MsgCreateGroupWithPolicyResponse);
registry.register("/cosmos.group.v1.MsgUpdateGroupPolicyAdminResponse", Cosmos.Group.MsgUpdateGroupPolicyAdminResponse);
registry.register("/cosmos.group.v1.MsgUpdateGroupPolicyDecisionPolicy", Cosmos.Group.MsgUpdateGroupPolicyDecisionPolicy);
registry.register("/cosmos.group.v1.MsgUpdateGroupPolicyDecisionPolicyResponse", Cosmos.Group.MsgUpdateGroupPolicyDecisionPolicyResponse);
registry.register("/cosmos.group.v1.MsgUpdateGroupPolicyMetadata", Cosmos.Group.MsgUpdateGroupPolicyMetadata);
registry.register("/cosmos.group.v1.MsgUpdateGroupPolicyMetadataResponse", Cosmos.Group.MsgUpdateGroupPolicyMetadataResponse);
registry.register("/cosmos.group.v1.MsgSubmitProposal", Cosmos.Group.MsgSubmitProposal);
registry.register("/cosmos.group.v1.MsgSubmitProposalResponse", Cosmos.Group.MsgSubmitProposalResponse);
registry.register("/cosmos.group.v1.MsgWithdrawProposal", Cosmos.Group.MsgWithdrawProposal);
registry.register("/cosmos.group.v1.MsgWithdrawProposalResponse", Cosmos.Group.MsgWithdrawProposalResponse);
registry.register("/cosmos.group.v1.MsgVote", Cosmos.Group.MsgVote);
registry.register("/cosmos.group.v1.MsgVoteResponse", Cosmos.Group.MsgVoteResponse);
registry.register("/cosmos.group.v1.MsgExec", Cosmos.Group.MsgExec);
registry.register("/cosmos.group.v1.MsgExecResponse", Cosmos.Group.MsgExecResponse);
registry.register("/cosmos.group.v1.MsgLeaveGroup", Cosmos.Group.MsgLeaveGroup);
registry.register("/cosmos.group.v1.MsgLeaveGroupResponse", Cosmos.Group.MsgLeaveGroupResponse);

registry.register("/cosmos.bank.v1beta1.MsgSend", Cosmos.Bank.MsgSend);
registry.register("/cosmos.bank.v1beta1.MsgSendResponse", Cosmos.Bank.MsgSendResponse);
registry.register("/cosmos.bank.v1beta1.MsgMultiSend", Cosmos.Bank.MsgMultiSend);
registry.register("/cosmos.bank.v1beta1.MsgMultiSendResponse", Cosmos.Bank.MsgMultiSendResponse);

registry.register("/cosmos.distribution.v1beta1.MsgSetWithdrawAddress", Cosmos.Distribution.MsgSetWithdrawAddress);
registry.register("/cosmos.distribution.v1beta1.MsgSetWithdrawAddressResponse", Cosmos.Distribution.MsgSetWithdrawAddressResponse);
registry.register("/cosmos.distribution.v1beta1.MsgWithdrawDelegatorReward", Cosmos.Distribution.MsgWithdrawDelegatorReward);
registry.register("/cosmos.distribution.v1beta1.MsgWithdrawDelegatorRewardResponse", Cosmos.Distribution.MsgWithdrawDelegatorRewardResponse);
registry.register("/cosmos.distribution.v1beta1.MsgWithdrawValidatorCommission", Cosmos.Distribution.MsgWithdrawValidatorCommission);
registry.register("/cosmos.distribution.v1beta1.MsgWithdrawValidatorCommissionResponse", Cosmos.Distribution.MsgWithdrawValidatorCommissionResponse);
registry.register("/cosmos.distribution.v1beta1.MsgFundCommunityPool", Cosmos.Distribution.MsgFundCommunityPool);
registry.register("/cosmos.distribution.v1beta1.MsgFundCommunityPoolResponse", Cosmos.Distribution.MsgFundCommunityPoolResponse);
registry.register("/cosmos.distribution.v1beta1.CommunityPoolSpendProposal", Cosmos.Distribution.CommunityPoolSpendProposal);

registry.register("/cosmos.crisis.v1beta1.MsgVerifyInvariant", Cosmos.Crisis.MsgVerifyInvariant);
registry.register("/cosmos.crisis.v1beta1.MsgVerifyInvariantResponse", Cosmos.Crisis.MsgVerifyInvariantResponse);

registry.register("/cosmos.vesting.v1beta1.MsgCreateVestingAccount", Cosmos.Vesting.MsgCreateVestingAccount);
registry.register("/cosmos.vesting.v1beta1.MsgCreateVestingAccountResponse", Cosmos.Vesting.MsgCreateVestingAccountResponse);
registry.register("/cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccount", Cosmos.Vesting.MsgCreatePermanentLockedAccount);
registry.register("/cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccountResponse", Cosmos.Vesting.MsgCreatePermanentLockedAccountResponse);
registry.register("/cosmos.vesting.v1beta1.MsgCreatePeriodicVestingAccount", Cosmos.Vesting.MsgCreatePeriodicVestingAccount);
registry.register("/cosmos.vesting.v1beta1.MsgCreatePeriodicVestingAccountResponse", Cosmos.Vesting.MsgCreatePeriodicVestingAccountResponse);

registry.register("/cosmos.staking.v1beta1.MsgCreateValidator", Cosmos.Staking.MsgCreateValidator);
registry.register("/cosmos.staking.v1beta1.MsgCreateValidatorResponse", Cosmos.Staking.MsgCreateValidatorResponse);
registry.register("/cosmos.staking.v1beta1.MsgEditValidator", Cosmos.Staking.MsgEditValidator);
registry.register("/cosmos.staking.v1beta1.MsgEditValidatorResponse", Cosmos.Staking.MsgEditValidatorResponse);
registry.register("/cosmos.staking.v1beta1.MsgDelegate", Cosmos.Staking.MsgDelegate);
registry.register("/cosmos.staking.v1beta1.MsgDelegateResponse", Cosmos.Staking.MsgDelegateResponse);
registry.register("/cosmos.staking.v1beta1.MsgBeginRedelegate", Cosmos.Staking.MsgBeginRedelegate);
registry.register("/cosmos.staking.v1beta1.MsgBeginRedelegateResponse", Cosmos.Staking.MsgBeginRedelegateResponse);
registry.register("/cosmos.staking.v1beta1.MsgUndelegate", Cosmos.Staking.MsgUndelegate);
registry.register("/cosmos.staking.v1beta1.MsgUndelegateResponse", Cosmos.Staking.MsgUndelegateResponse);
registry.register("/cosmos.staking.v1beta1.MsgCancelUnbondingDelegation", Cosmos.Staking.MsgCancelUnbondingDelegation);
registry.register("/cosmos.staking.v1beta1.MsgCancelUnbondingDelegationResponse", Cosmos.Staking.MsgCancelUnbondingDelegationResponse);

registry.register("/cosmos.params.v1beta1.ParameterChangeProposal", Cosmos.Params.ParameterChangeProposal);

registry.register("/cosmos.authz.v1beta1.MsgGrant", Cosmos.Authz.MsgGrant);
registry.register("/cosmos.authz.v1beta1.MsgExecResponse", Cosmos.Authz.MsgExecResponse);
registry.register("/cosmos.authz.v1beta1.MsgExec", Cosmos.Authz.MsgExec);
registry.register("/cosmos.authz.v1beta1.MsgGrantResponse", Cosmos.Authz.MsgGrantResponse);
registry.register("/cosmos.authz.v1beta1.MsgRevoke", Cosmos.Authz.MsgRevoke);
registry.register("/cosmos.authz.v1beta1.MsgRevokeResponse", Cosmos.Authz.MsgRevokeResponse);

registry.register("/cosmos.slashing.v1beta1.MsgUnjail", Cosmos.Slashing.MsgUnjail);
registry.register("/cosmos.slashing.v1beta1.MsgUnjailResponse", Cosmos.Slashing.MsgUnjailResponse);

registry.register("/cosmos.gov.v1.MsgSubmitProposal", Cosmos.GovV1.MsgSubmitProposal);
registry.register("/cosmos.gov.v1.MsgSubmitProposalResponse", Cosmos.GovV1.MsgSubmitProposalResponse);
registry.register("/cosmos.gov.v1.MsgExecLegacyContent", Cosmos.GovV1.MsgExecLegacyContent);
registry.register("/cosmos.gov.v1.MsgExecLegacyContentResponse", Cosmos.GovV1.MsgExecLegacyContentResponse);
registry.register("/cosmos.gov.v1.MsgVote", Cosmos.GovV1.MsgVote);
registry.register("/cosmos.gov.v1.MsgVoteResponse", Cosmos.GovV1.MsgVoteResponse);
registry.register("/cosmos.gov.v1.MsgVoteWeighted", Cosmos.GovV1.MsgVoteWeighted);
registry.register("/cosmos.gov.v1.MsgVoteWeightedResponse", Cosmos.GovV1.MsgVoteWeightedResponse);
registry.register("/cosmos.gov.v1.MsgDeposit", Cosmos.GovV1.MsgDeposit);
registry.register("/cosmos.gov.v1.MsgDepositResponse", Cosmos.GovV1.MsgDepositResponse);

registry.register("/cosmos.gov.v1beta1.MsgSubmitProposal", Cosmos.GovV1beta1.MsgSubmitProposal);
registry.register("/cosmos.gov.v1beta1.MsgSubmitProposalResponse", Cosmos.GovV1beta1.MsgSubmitProposalResponse);
registry.register("/cosmos.gov.v1beta1.MsgVote", Cosmos.GovV1beta1.MsgVote);
registry.register("/cosmos.gov.v1beta1.MsgVoteResponse", Cosmos.GovV1beta1.MsgVoteResponse);
registry.register("/cosmos.gov.v1beta1.MsgVoteWeighted", Cosmos.GovV1beta1.MsgVoteWeighted);
registry.register("/cosmos.gov.v1beta1.MsgVoteWeightedResponse", Cosmos.GovV1beta1.MsgVoteWeightedResponse);
registry.register("/cosmos.gov.v1beta1.MsgDeposit", Cosmos.GovV1beta1.MsgDeposit);
registry.register("/cosmos.gov.v1beta1.MsgDepositResponse", Cosmos.GovV1beta1.MsgDepositResponse);
registry.register("/cosmos.gov.v1beta1.TextProposal", Cosmos.GovV1beta1.TextProposal);
registry.register("/cosmos.gov.v1beta1.Proposal", Cosmos.GovV1beta1.Proposal);
