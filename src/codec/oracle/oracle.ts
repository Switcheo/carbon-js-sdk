...
export const Params = {
  encode(
    ...
    if (message.oracleSlashWindowBlock !== 0) {
      writer.uint32(8).uint32(message.oracleSlashWindowBlock);
    }
    if (message.oracleSlashInitial !== "") {
      writer.uint32(18).string(message.oracleSlashInitial);
    }
    if (message.oracleSlashIncrement !== "") {
      writer.uint32(26).string(message.oracleSlashIncrement);
    }
    if (message.oracleContinuousSlashMax !== 0) {
      writer.uint32(32).uint32(message.oracleContinuousSlashMax);
    }
    if (message.newlyBondedWindowAllowance !== 0) {
      writer.uint32(40).uint32(message.newlyBondedWindowAllowance);
    }
    ...
    if (message.oracleMinVoteFactor !== "") {
      writer.uint32(58).string(message.oracleMinVoteFactor);
    }
    if (message.maxPowerToSlashFactor !== "") {
      writer.uint32(66).string(message.maxPowerToSlashFactor);
    }
    return writer;
  },
