...
const baseExtendedCommit: object = { height: Long.ZERO, round: 0 };
  ...
  fromJSON(object: any): ExtendedCommit {
    ...
    message.blockId =
      object.blockId !== undefined && object.blockId !== null
        ? BlockID.fromJSON(object.blockId)
        : undefined;
    message.extendedSignatures = (object.extendedSignatures ?? []).map(
      (e: any) => ExtendedCommitSig.fromJSON(e)
    );
    return message;
  },
  ...
  fromPartial(object: DeepPartial<ExtendedCommit>): ExtendedCommit {
    ...
    message.blockId =
      object.blockId !== undefined && object.blockId !== null
        ? BlockID.fromPartial(object.blockId)
        : undefined;
    message.extendedSignatures = (object.extendedSignatures ?? []).map((e) =>
