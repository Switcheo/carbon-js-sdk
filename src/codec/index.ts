...
registry.register("/Switcheo.carbon.cdp.MsgAddRewardReserve", MsgAddRewardReserve);
registry.register("/Switcheo.carbon.cdp.MsgAddRewardReserveResponse", MsgAddRewardReserveResponse);
...
export const TxTypes = {
  ...
  "MsgAddRewardReserve": "/Switcheo.carbon.cdp.MsgAddRewardReserve",
  "MsgAddRewardReserveResponse": "/Switcheo.carbon.cdp.MsgAddRewardReserveResponse",
...
export { NewRateStrategyParamsEvent, UpdateRateStrategyParamsEvent, RemoveRateStrategyParamsEvent, NewAssetParamsEvent, UpdateAssetParamsEvent, SetInterestFeeEvent, SetLiquidationFeeEvent, SetStablecoinInterestRateEvent, SetStablecoinMintCapEvent, SetCompleteLiquidationThresholdEvent, SetMinimumCloseFactorEvent, SetSmallLiquidationSizeEvent, SupplyAssetEvent, WithdrawAssetEvent, BorrowAssetEvent, RepayAssetEvent, LockCollateralEvent, UnlockCollateralEvent, UpdateDebtInfoEvent, UpdateStablecoinDebtInfoEvent, MintStablecoinEvent, ReturnStablecoinEvent, LiquidateCollateralEvent, LiquidateCollateralWithStablecoinEvent, ClaimRewardEvent, RewardDebtEvent, RewardSchemeEvent, AddReserveEvent } from "./cdp/event";
