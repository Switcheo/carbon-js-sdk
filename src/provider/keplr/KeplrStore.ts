...
export class RootStore {
  ...
  constructor(getKeplr: () => Promise<any>, additionalChains?: ChainInfo[]) {
    ...
    this.queriesStore = new QueriesStore(new IndexedDBKVStore("store_queries"), this.chainStore, getKeplr, QueriesWithCosmos);

    this.accountStore = new AccountStore(window, AccountWithCosmos, this.chainStore, this.queriesStore, {
      defaultOpts: {
        prefetching: false,
        suggestChain: true,
        autoInit: true,
